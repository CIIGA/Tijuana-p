    ...
    <tr>
        ...
        <td class="table-light" style="text-align:center;">
            <button type="button" class="btnDeleteEjecutor btn btn-light btn-sm" title="Eliminar"
                data-id="{{ $item->id_d }}" data-ejecutor="{{ $item->ejecutor }}">
    ...
    $(document).ready(function() {
        ...
        $(document).off('click', '.btnDeleteEjecutor').on('click', '.btnDeleteEjecutor', function() {
            ...
            // Confirmar con el usuario antes de eliminar
                ...
                $.ajax({
                    url: 'https://gallant-driscoll.198-71-62-113.plesk.page/implementta/modulos/Tijuana-p/public/delete_ejecutor',
                    method: 'GET',
                    data: {
                        ejecutor: ejecutor,
                        id_d: id // Asegúrate de que el nombre del parámetro coincida con el del controlador
                    },
